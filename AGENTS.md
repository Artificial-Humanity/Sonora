...
* **The steps, the cap, escalation and `user_decision` are in
  ...
  * ⚠ **The rules are also MECHANISMS now, which is why restating them here is worse than
    ...
    above the **severity floor** — MEDIUM and up blocks; LOW rides to a follow-up; ungraded
    and escalated block at any severity (owner, ratified 2026-08-19, built 2026-08-20).
