...
Usage:
    .venv/bin/python scripts/tools/gate_calibration.py --campaign-dir /data/.../revisit-v1 \
        [--verdicts qc_verdicts.per_engine.jsonl] [--keep-score 4]

    # what threshold should head_lost_frac have?
    .venv/bin/python scripts/tools/gate_calibration.py --campaign-dir /data/.../librivox-v2 \
