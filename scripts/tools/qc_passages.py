...
Usage:
    .venv/bin/python scripts/tools/qc_passages.py --bank <bank.json> [--json report.jsonl] [--write-clean out.json]
    .venv/bin/python scripts/tools/qc_passages.py --chunks <chunks.jsonl>          # book_ingest intermediate
