...
wav is on disk, and `--retire` is the explicit way to close out the other case.
    ...
    .venv/bin/python scripts/tools/requeue_reroll.py --bank <bank.json>
    .venv/bin/python scripts/tools/requeue_reroll.py --bank <bank.json> --apply
    .venv/bin/python scripts/tools/requeue_reroll.py --retire ID --superseded-by ID --apply
"""
import argparse
import json
import os
