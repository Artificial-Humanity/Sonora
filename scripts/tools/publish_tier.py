...
Usage:
    .venv/bin/python scripts/tools/publish_tier.py --meta <metadata.jsonl>            # check (default)
    .venv/bin/python scripts/tools/publish_tier.py --meta <metadata.jsonl> --apply    # backfill missing fields
"""
import argparse
import json
import os
