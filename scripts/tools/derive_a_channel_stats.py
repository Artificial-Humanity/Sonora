...
`scripts/gates/test_doc_claims.py` is the gate, it owns the corpus/checkpoint registry, and it is
...
Run:  .venv/bin/python scripts/tools/derive_a_channel_stats.py
