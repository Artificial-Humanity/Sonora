...
Run:
  .venv/bin/python scripts/stages/register_audition.py \
      --book /data/model-training/datasets/book-prose/apple-cart [--dry-run]
  # every book under the book-prose root:
  .venv/bin/python scripts/stages/register_audition.py --all [--dry-run]
  # or point straight at a manifests dir (what synth_bank.sh passes as its out_dir):
  .venv/bin/python scripts/stages/register_audition.py --audio-dir <out_dir> [--dry-run]
"""
import argparse
import ast
import csv
