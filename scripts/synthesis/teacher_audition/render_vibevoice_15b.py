"""quote-pilot-v3d: VibeVoice-1.5B arm (MIT, official MS weights) — v3e footprint comparison.
...
OUT = "/data/model-training/datasets/sonora-expressive-registers/quote-pilot-v3d/vibevoice_15b"
MODEL_DIR = "/data/models/microsoft/VibeVoice-1.5B"
...
manifest = open(os.path.join(OUT, "vibevoice_15b_manifest.jsonl"), "w")
for row in bank:
