...
| **Emilia-YODAS keeps** | Amphion, CC-BY-4.0 (**YODAS subset only**). Mined and resampled to 24 kHz, 5.4 GB | **TRAINED** (2026-08-08) — merged as **10,997 keeps** of `libritts_r_emilia_vat_v5` — **10,653 train + 344 val** — taking the corpus to **41,138 train / 1,304 val** (42,442 total), 78.5 h, 2,500 speakers. The planned 13,141 became 10,997 on contact: 1,676 dropped on digits (D-M3) and 468 on the shared `ASR_MAX_WER`. ⚠ **Both 10,653 and 10,997 are correct and they measure different things** — this cell said 10,653 beside 41,138, which is a consistent TRAIN-only statement, and the 2026-08-09 review called it "simply wrong" by differencing TOTALS (42,442 − 31,445 = 10,997). The defect was never a wrong number; it was an unstated unit. Say which split, always: `derivation_report.json` carries `emilia.kept` 10,997, `emilia.train` 10,653, `emilia.val` 344 | None. ⚠ It did **not** bring real newscaster/documentary audio — the mining verdict expected that and it did not survive: **100% of Emilia rows carry blank delivery.** Those lanes still have no real audio from any source |
