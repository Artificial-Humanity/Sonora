...
> standing is `notes/teacher-tts-audition-shortlist.md` (private)
> and the remaining tier questions are `notes/todo.md` (private).

Source of record: `notes/teacher-tts-audition-shortlist.md` (private)
