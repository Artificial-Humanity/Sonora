...
class MatchaTTS(BaseLightningClass):  # 🍵
    ...
    def synthesise(self, x, x_lengths, n_timesteps, temperature=1.0, spks=None, length_scale=1.0, vat=None,
        ...
        if torch.onnx.is_in_onnx_export():
            y_max_length_ = torch.scalar_tensor(1024, dtype=torch.long, device=x.device)
            y_max_length = y_max_length_
        else:
    ...
    def forward(self, x, x_lengths, y, y_lengths, spks=None, out_size=None, cond=None, durations=None, vat=None):
        ...
        if self.use_precomputed_durations:
            attn = generate_path(durations.squeeze(1), attn_mask_squeezed)
        else:
            ...
            with torch.no_grad():
                ...
                attn = monotonic_align.maximum_path(log_prior, attn_mask_squeezed)
